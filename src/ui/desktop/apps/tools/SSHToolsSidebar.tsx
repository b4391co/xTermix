...
const HOTKEY_GROUPS = [
  {
    title: "Terminales",
    items: [
      ["Alt + T", "Abrir una nueva terminal"],
      ["Alt + W", "Cerrar la terminal o panel enfocado"],
      ["Alt + D", "Dividir verticalmente sobre el panel enfocado"],
      ["Alt + E", "Dividir horizontalmente sobre el panel enfocado"],
      ["Alt + Flechas", "Mover el panel enfocado dentro del split"],
    ],
  },
  {
    title: "Portapapeles",
  ...
  },
  {
    title: "Interfaz",
    items: [
      ["Shift, Shift", "Abrir o cerrar la paleta de comandos"],
      ["Alt izquierdo, Alt izquierdo", "Cambiar entre tema claro y oscuro"],
      ["Escape", "Cerrar paletas u overlays abiertos"],
    ],
  },
];
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-3">
                        {HOTKEY_GROUPS.map((group) => (
                          <div
                            key={group.title}
                            className="rounded-lg border border-edge bg-canvas/60 p-3"
                          >
                            ...
                            <div className="space-y-2">
                              {group.items.map(([keys, description]) => (
                                ...
                                >
                                  ...
                                  <kbd className="shrink-0 rounded border border-edge bg-muted px-2 py-1 font-mono text-xs text-foreground">
                                    {keys}
                                  </kbd>
                                </div>
                              ))}
                      ...
                      <p className="text-xs text-muted-foreground">
                        Ctrl + W y Ctrl + T no se usan porque el navegador los
                        reserva para cerrar y abrir pestañas.
                      </p>
                    </div>
                  </TabsContent>
